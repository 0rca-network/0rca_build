...
const blocks = [
  {
    ...
    description: "Seamlessly deploy autonomous agents with intuitive tools and comprehensive documentation.",
    icon: Box,
  },
  {
    title: "Monetization Layers",
    description: "Built-in revenue streams and tokenomics for sustainable agent operations and growth.",
    icon: Coins,
  },
  {
    title: "Decentralized Compute",
    description: "Harness distributed computing power for high-performance agent execution across the network.",
    icon: Cpu,
  },
]
